...
class status_offline extends StatefulWidget {
  const status_offline({Key? key}) : super(key: key);

  @override
  State<status_offline> createState() => _status_offlineState();
}

class _status_offlineState extends State<status_offline> {
  @override
                        ...
                        rows: [
                          ...
                          DataRow(
                              ...
                              cells: <DataCell>[
                                ...
                                DataCell(RowCell(rowText: "Offline",)),
